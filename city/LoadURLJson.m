...
//   }
//   
//   //NSString* baseURL =  @"https://practice-scoop.herokuapp.com"; //@"http://www.jirnil.com";
//   NSString* authTokenBase = [[BTSession thisSession] getAuthTokenBase];
//   NSString* baseParameters = [NSString stringWithFormat:@"&sk=foeiuh9q28734gfa9w8hfg92830rq892g0oaw8hf&usk=%@&uid=%@", [authTokenBase shaEncrypted], [[BTSession thisSession] loggedInUserID]];
//   
//   LoadURLJson *loadJson = [[self alloc] init];
//   if ([method isEqualToString:@"GET"]) {
//      loadJson.urlString = [NSString stringWithFormat:@"%@%@%@", [[BTSession thisSession] baseURL], aURLString, baseParameters ];
//   } else if ([method isEqualToString:@"PUT"] || [method isEqualToString:@"DELETE"]) {
//      loadJson.urlString = [NSString stringWithFormat:@"%@%@%@", [[BTSession thisSession] baseURL], aURLString, baseParameters ];
//   } else {
//      loadJson.urlString = [NSString stringWithFormat:@"%@%@", [[BTSession thisSession] baseURL], aURLString ];
//   }
